...
if __name__ == '__main__':
	...
	encoded_video : str = LED16x16.encode_video( video_filepath, NTH_FRAME=3, MAX_FRAMES=1000, debug=True )
	...
	# encoded_image : str = LED16x16.encode_image( Image.open(image_filepath), GRID_SIZE=16 )
	...
	# 	image : Image.Image =  ImageEditor.to_grayscale_pixelated( image_filepath , grid=grid_size, bgc = 0, centered=True )
